						    ...
						    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parents="#accordionExample">
						      <div class="accordion-body">
						        <p>For the purposes of this Privacy Policy:</p>
									...
									<li>
									<p><strong>Website</strong> refers to Join Ratings, accessible from <a href="https://osabox.co" rel="external nofollow noopener" target="_blank">https://osabox.co</a></p>
									</li>
									<li>
					  	...
					  	<div class="accordion-item">
						    ...
						    <div id="collapse_4" class="accordion-collapse collapse" aria-labelledby="heading_4" data-bs-parents="#accordionExample">
						      <div class="accordion-body">
								...
								<ul>
									<li>By visiting this page on our website: <a href="https://osabox.co/contact" rel="external nofollow noopener" target="_blank">https://osabox.co/contact</a></li>
								</ul>
						      </div>
						    </div>
					  	</div>
