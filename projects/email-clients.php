      					...
      					<div class="col-md-12">     						
      						<div class="card card-primary">
      							<div class="card-header">
      								<h4 class="card-title">Clients Emails</h4>
      							</div>
      							
  								<?php 
  									$query = $connect->prepare("SELECT * FROM clients WHERE parent_id = ? AND branch_id = ? AND email != '' ");
											...
											<table class="cell-table" id="myTable">  
												...
												<?php  
													...
													<tr id="<?php echo $row['id']?>">
														...
														<td><a href="sentEmails?user_email=<?php echo $email?>&username=<?php echo $firstname ?>">View <?php echo countEmails($connect, $email, $_SESSION['parent_id'])?> Email</a></td>
														<td data-column="Edit">
															<a href="our-clients"><i class="bi bi-pencil-square" aria-hidden="true"></i></a>
													</tr>
												<?php	
													}
												?>
