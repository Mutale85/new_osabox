<?php 
  	...
  	if (isset($_COOKIE['projectViewed']) && isset($_COOKIE['teamMemberId'])) {
  	 	$staff = $_COOKIE['projectViewed'];
  	 	$project_id = $_COOKIE['projectID'];
  	 	$tid = $_COOKIE['teamMemberId'];
  	 	$query = $connect->prepare("UPDATE projects_team_members SET seen = '1' WHERE tid = ?");
		      	...
		      	<div class="card">
		        	<div class="card-header">
		          		...
		          		<div class="card-tools">
		            		...
		            		<a href="<?php echo $projectID?>" class="btn btn-primary shadow projectMilestone" >ADD MILESTONE</a>
		          		</div>
		        	</div>
		        	<div class="card-body">
		          		<div class="row">
		            		...
		            		<div class="col-12 col-md-12 col-lg-4 order-1 order-md-1 bg-light p-4 shadow mb-5">
		              			...
		              			?>
					                ...
					                <li>
					                  	<a href="files/<?php echo $file?>" target="_blank" class="btn-link text-secondary"><i class="far fa-fw fa-file"></i> <?php echo $file?></a>
					                </li>
					            <?php
					                	}
		              				}
		                			...
		                			<div class="col-12">
		                    			...
		                    			<div class="post mb-5 shadow p-4">
						                    ...
						                    <p>Amount Spent: <?php echo $currency?> <?php echo $spent_budget?></p>
		                      				<p>
		                        				<a href="files/<?php echo $attachment?>" target="_blank" class=" text-primary text-sm"><i class="fas fa-link mr-1"></i> <?php echo $attachment?></a>
		                      				</p>
		                      				<?php echo $edit;?>
		                    			</div>
		                    			<?php
				            	...
				            	<div class="modal-body">
				            		...
				            		<div class="form-group">
					                	...
					                	<div class="input-group">
					                		<span id="" class="input-group-text"><?php echo getCurrency($connect, $_SESSION['parent_id'])?></span>
	...
	<script>
		...
		$(function(){
			...
			$("#milestoneForm").submit(function(e){
				...
				var url = 'submit-projectMilestone';
				$.ajax({
