<?php
	...
	if (isset($_POST['fetchinProgressTasksKanBan'])) {
		$branch_id = $_POST['branch_id'];
		$sql = $connect->prepare("SELECT * FROM `todolist` WHERE parent_id = ? AND branch_id = ?  AND task_status = 'progress' ORDER BY id DESC ");
	 	...
	 	if ($sql->rowCount() > 0) {
            ...
            <div class='task border-info' draggable='true'>
				...
				<div class='task__stats'>
					<span><time datetime="2021-11-24T20:00:00"><i class="bi bi-clock-history"></i> <?php echo date("M-d, Y", strtotime($progress_date)) ?></time></span>
