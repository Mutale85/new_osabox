								...
								if ($row) {
									...
									$query_two = $connect->prepare("SELECT * FROM sms_prices WHERE Prefix = ?");
      								...
      								if ($query_two->rowCount() > 0) {
      									...
      									if ($roq) {
      										extract($roq);
      										$remaining = "Free SMS: ". (ceil(1 / $Price) - 1);
										...
										<div class="table table-responsive">
											<table class="table cell-table" id="myTable">  
												...
												<?php  
													...
													?>
													<tr id="<?php echo $id?>">
														<td data-column="Send SMS"><input type="checkbox" name="checked_user[]" class="checkSingle" id="checked_user" value="<?php echo preg_replace("#[^0-9]#", "", $phone)?>"></td>
														<td data-column="Firstname"><?php echo $firstname ?></td>
														<td data-column="Lastname"><?php echo $lastname?></td>
														<td data-column="Lastname"><?php echo $company_name?></td>
														<td data-column="Mobile"><?php echo $phone?></td>
														<td><a href="sentSMS?user_phone=<?php echo $phone?>&username=<?php echo $firstname ?>">View <?php echo countSMS($connect, $phone, $_SESSION['parent_id'])?> SMS</a></td>
