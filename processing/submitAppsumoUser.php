...
if (isset($_POST['firstname'])) {
    ...
    $statement  = $connect->prepare("SELECT * FROM sales_code WHERE unique_code = ? LIMIT 1");
    ...
    if ($countRows == 1) {
        ...
        $update_stmt = $connect->prepare("UPDATE sales_code SET sold_status = '1', buyer_email = ?, currency = ?, amount = ?, date_sold = now() WHERE unique_code = ?  ");
    	...
    	if($execute){ 
                        ...
                        <tr>
                            <td>
                                <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                                    ...
                                    <tr>
                                        <td style="text-align:center;">
                                          <a href="https://osabox.net" title="logo" target="_blank">
                                            <img width="80" src="https://osabox.net/images/icon2.png" title="logo" alt="logo">
                                          </a>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    <td style="padding:0 35px;">
                                                        ...
                                                        <div style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                            ...
                                                            <a href="https://osabox.net/activation?userid='.$parent_id.'&email='.$email.'&pass='.$password.'" class="linkBtn"> Activate Account</a>
                                                            <p> You can also copy and paste the link below into your browser.</p>
                                                            <p>https://osabox.net/activation?userid='.$parent_id.'&email='.$email.'&pass='.$password.'</p>
                                    ...
                                    <tr>
                                        <td style="text-align:center;">
                                            <h4>UNCOMPLICATED CLOUD BASED TRIPLE MANAGEMENT SYSTEM</h4>
                                            <p>Payroll Management System | Projects Management System | Loan Management System</p>
    		...
    		$mail->Body = $message;
    		if($mail->send()){
    			echo 'Appsumo code redeemed and your account has created please check your email inbox or spam for a verification link sent to. '.$email; 
    		}else{
