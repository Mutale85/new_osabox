...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	// var staff_country = document.getElementById('staff_country');
	// staff_country.onchange = function () {
	// 	localStorage['staff_country'] = this.value;
	// }
	// document.addEventListener('DOMContentLoaded', function () {
	//  	var staff_country = document.getElementById('staff_country');
	//  	if (localStorage['staff_country']) { 
	//      	staff_country.value = localStorage['staff_country'];
	//  	}
	//  	staff_country.onchange = function () {
	//       	localStorage['staff_country'] = this.value;
	//   	}
