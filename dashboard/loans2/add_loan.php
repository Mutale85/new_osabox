...
<body class="hold-transition sidebar-mini layout-fixed">
      			...
      			<div class="container-fluid mt-5 mb-5">
      				<div class="row mt-5">
      					<div class="col-md-12 mt-4 pb-2 d-flex justify-content-between border-bottom">
  							<h1 class="h4"><?php echo ucwords(getBranchName($connect, $_SESSION['parent_id'], $BRANCHID))?> Loan Applications</h1>
      								...
      								<form method="post" id="loanForm">
										...
										<div class="card-body">
											...
											<div class="row">
												...
												<div class="col-md-6 mb-3">
													<label>Loan No:</label>
													<input type="text" name="loan_number" id="loan_number" class="form-control" placeholder="Will Auto Fill" readonly>
													<!-- This will be the same as NRC, and will be ready only -->
												</div>
												<div class="col-md-6 mb-3">
	...
	<script>
		...
		function fetchLoanID(borrower_card_id_get_loan_number){
			// if (borrower_card_id_get_loan_number === "") {
			// 	alert("Select Loan Plan");
			// 	return false;
			// }else{
				// we make an ajax call to find collecctors to assign the work to.
	...
	<script>
		...
		// var saveLoan = document.getElementById('saveLoan');
		// saveLoan.addEventListener('click', (e) => {
		// 	var xhr = new XMLHttpRequest();
		// 	var loanForm = document.getElementById('loanForm');
		// 	var data = new FormDat(loanForm);
		// 	var url = 'loans/submitLoan'
		// 	xhr.open("POST", url, true);
		// 	xhr.onreadystatechange = function(){
		// 		if (xhr.readyState == 4 && xhr.status == 200) {
