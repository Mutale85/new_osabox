											...
											<table class="table cell-table" id="myTable">  
												...
												<?php  
													...
													<tr id="<?php echo $row['id']?>">
														...
														<td><a href="SMSFIles/sentSMS?user_phone=<?php echo $row['borrower_phone']?>&username=<?php echo $row['borrower_firstname'] ?>">View <?php echo countSMS($connect, $row['borrower_phone'], $_SESSION['parent_id'])?> SMS</a></td>
														<td data-column="Edit">
	...
	<script>
		...
		$("#sms-btn").click(function(){
			if ($(".checkSingle").is(":checked")) {
				...
				$.ajax({
					url:"SMSFIles/send-sms-to-borrower",
					method:"post",
					data:formData,
					cache:false,
					processData:false,
