									        	...
									        	<?php
													...
													if ($numRows > 0 ) {
														...
														foreach ($query->fetchAll() as $row) {?>
															<tr>
																<td><?php echo $i++?></td>
																<td><b><?php echo $row['loan_number']?></b></td>
																<td>
																	<a href="borrowers/view_borrower_details?borrower_id=<?php echo $row['borrower_id']?>">
																		<?php echo ucfirst(getBorrowerFullNamesByCardId($connect, $row['borrower_id']))?>
																	</a>
																</td>
																<td>
