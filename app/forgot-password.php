  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">You forgot your password? Here you can easily retrieve a new password.</p>
      	<form method="post" id="passrecoverForm">
...
<script>
    ...
    var btn = document.getElementById('btn');
    var recoverForm = document.getElementById('passrecoverForm');
    var email = document.getElementById('email');    
    var url = 'includes/recover-password';
    var xhr = new XMLHttpRequest();
    
    passrecoverForm.addEventListener('submit', (event) => {
      event.preventDefault();
      if(email.value == ""){
        alert("email is required");
        email.focus();
      ...
      var data = new FormData(passrecoverForm);
      xhr.open('POST', url, true);
      xhr.onreadystatechange = function(){
        if(xhr.readyState == 4 && xhr.status == 200) {
          r = xhr.responseText;
