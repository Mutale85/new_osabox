      			...
      			<div class="container-fluid mt-5 mb-5">
      				<div class="row mt-5">
      					<div class="col-md-12 mt-4 pb-2 d-flex justify-content-between">
  							<a href="payroll/payslip_pdf?payroll_id=<?php echo $_GET['payroll_id']?>&parent_id=<?php echo $_GET['parent_id']?>&staff_id=<?php echo $_GET['staff_id']?>" class="btn btn-outline-primary btn-lg mt-5"> Generate PDF</a>
  						</div>
      				</div>
      			</div>
      			<div class="container">
      					...
      					<div class="col-md-12">
      						<div class="card card-primary">
								...
								<div class="tableDiv">
									...
									<a href="payroll/payslip_pdf?payroll_id=<?php echo $payroll_id?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $staff_id?>" class="btn btn-outline-primary btn-lg mt-5"> Generate PDF</a>
								</div>
								</div>
      						</div>
      					</div>
