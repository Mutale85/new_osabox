      				...
      				<div class="row">
      					<div class="col-md-12">     						
      						<div class="card card-primary">
  								...
  								<?php 
  									$query = $connect->prepare("SELECT * FROM borrowers WHERE branch_id = ? AND parent_id = ? ");
											...
											<table class="cell-table " id="myTable">  
												...
												<?php  
													...
													<tr id="<?php echo $row['id']?>">
														...
														<td><a href="SMSFIles/sentEmails?user_email=<?php echo $row['borrower_email']?>&username=<?php echo $row['borrower_firstname'] ?>">View <?php echo countEmails($connect, $row['borrower_email'], $_SESSION['parent_id'])?> Email</a></td>
														<td data-column="Edit">
