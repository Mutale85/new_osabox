  						...
  						<div class="col-md-4">
  							<div class="card card-primary card-outline mb-5">
          						<div class="card-body box-profile">
					                ...
					                <a href="loans/create-new-loan?borrower_id=<?php echo $_GET['borrower_id']?>" class="btn btn-primary btn-block"><b>Issue Loan</b> </a>
					            </div>
        					</div>
  						</div>
  						<div class="col-md-8">
											...
											<tbody>
		      								...
		      								<?php
												...
												if ($query->rowCount() > 0) {
													...
													?>
													<td>
														<a href="loans/view_loan_details?loan_number=<?php echo $loan_number?>&borrower_id=<?php echo $_GET['borrower_id']?>" class="text-primary"><?php echo $loan_number ?></a>
													</td>
													<td>
													...
													<td>
														<a href="loans/view_loan_details?loan_number=<?php echo $loan_number?>&borrower_id=<?php echo $_GET['borrower_id']?>" class="text-primary"><i class="bi bi-arrow-right-square"></i></a>
													</td>
												<?php
													}
												}
