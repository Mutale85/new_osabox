      									...
      									<table class="cell-table table-sm" id="payrollTable" style="width: 100%">
      										...
      										<tbody>
      											...
      											<tr class="text-dark">
      												...
      												<td>
      													<a href="staff-payroll?payroll_id=<?php echo $id;?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $employee_id?>" target="_blank"><small>View Payroll</small> </a>
      												</td>
                                                                              <td><a href="staffpayrollprint?payroll_id=<?php echo $id?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $employee_id?>"><small>Print Payslip <i class="bi bi-printer"></i></small> </a></td>
      											</tr>
      											<?php
      												}
      											?>
      								...
      								<div class="card-body">
      									...
      									<table class="cell-table table-sm" id="payrollTable" style="width: 100%">
      										...
      										<tbody class="text-dark">
      											<?php
                                                                              function getTotalAllowances($connect, $employee_id, $parent_id) {
                                                                                    $output = '';
                                                                                    ...
                                                                                    $query->execute(array($employee_id, $parent_id));
                                                                                    $row = $query->fetch();
                                                                                    if ($row) {
      											...
      											<tr>
      												<td><?php echo getStaffMemberNames($connect, $employee_id, $parent_id)?></td>
      												<td><?php echo $pay_date ?></td>
                                                                              <td><small><?php echo $the_currency?></small> <?php echo $salary_amount?></td>
                                                                              <td><small><?php echo $the_currency?></small> <?php echo getTotalAllowances($connect, $employee_id, $parent_id)?></td>
      												<td><small><?php echo $the_currency?></small> <?php echo number_format($grosspay, 2) ?></td>
      												<td><small><?php echo $the_currency?></small> <?php echo number_format($total_deductions, 2) ?></td>
      												<td><small><?php echo $the_currency?></small> <?php echo number_format($net_pay, 2) ?></td>
      												<td><a href="staffpayrollprint?payroll_id=<?php echo $id?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $employee_id?>" target="_blank"><small>Print Payslip <i class="bi bi-printer"></i></small> </a></td>
      												<td>
      													<a href="staff-payroll?payroll_id=<?php echo $id;?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $employee_id?>"><small>View Payroll</small> </a>
      												</td>
      											</tr>
      											<?php
      												}
