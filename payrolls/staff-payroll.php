      									...
      									<table class="cell-table table-sm" id="payrollTable" style="width: 100%">
      										...
      										<tbody>
      											...
      											<tr>
      												...
      												<td>
      													<a href="payroll-edit?payroll_id=<?php echo $id;?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $employee_id?>"><small><i class="bi bi-pencil-square"></i></small> </a>
      												</td>
      												<td>
      													<a href="staff-payroll?payroll_id=<?php echo $id?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $employee_id?>" data-payroll_id="<?php echo $id?>" class="deletePayroll"><small><i class="bi bi-trash text-danger"></i></small> </a>
      												</td>
      											</tr>
      											<?php
      												}
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="tableDiv">
                  ...
                  <a href="staffpayrollprint?payroll_id=<?php echo $payroll_id?>&parent_id=<?php echo $parent_id?>&staff_id=<?php echo $staff_id?>" class="btn btn-outline-primary mt-5" target="_blank"> Print Payslip <i class="bi bi-printer"></i></a>
                </div>
                </div>
                  </div>
                </div>
