...
<head>
	...
	<title>Knowledge Base - How to use the loan management tool</title>
</head>
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 mt-5">
					<!-- <img src="images/project.png" alt="project.svg" class="img-fluid project" width="100%"> -->
					<h1>Cookies</h1>

				</div>
				<div class="col-md-12 mt-5">
					<div class="cookies_details">
						<h1>Cookie Policy for osabox.net</h1>

						<p>This is the Cookie Policy for osabox.net, accessible from https://osabox.net/cookies</p>
						...
						<p>We use cookies for a variety of reasons detailed below. Unfortunately in most cases there are no industry standard options for disabling cookies without completely disabling the functionality and features they add to this site. It is recommended that you leave on all cookies if you are not sure whether you need them or not in case they are used to provide a service that you use.</p>
							...
							<p>We do not track your website visitors with cookies, we use their IP-Address as provived.</p>
							<p></p>
						...
						<ul>
							<li>By visiting this link: <a href="contact" title="contact"><i class="bi bi-envelope"></i> CONTACT US</a></li>
						</ul>
					</div>
				</div>
			</div>
